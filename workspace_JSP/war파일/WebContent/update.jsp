...
<div id="wrap">
		...
		<div id="section">
			...
			<form action="update_ok.do?num=${update_view.num}" method="post" name="write_form">
				<table>
					<tr>
						<td><label>제목</label></td>
					</tr>
						<tr>
						<td><label><input type="text" name="title" id="title" value="${update_view.title}"maxlength="50"></label></td>
					</tr>
					<tr>
						<td><label>내용</label></td>
					</tr>
					<tr>
						<td><textarea cols="70" rows="30" name="content" id="content">${update_view.content}</textarea></td>
					</tr>
					<tr>
						<td>
						<input type="button" value="글 수정" class="write_btn">
						</td>
					</tr>
				</table>
			</form>
