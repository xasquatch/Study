...
<body>
	...
	<script type="text/javascript">
		...
		function autoTimer() {
			...
			document.getElementById("left_time").innerHTML = left_time == "남은시간 : " ? "판매 종료" : left_time;
		}
	...
	<div id="wrap" class="wrap_min">
		...
		<div id="mainBoard">
			...
			<div id="imgAndBid">
				...
				<div id="bid_div">
					<%
					if(dto.getStatus() == 0 && dto.getEnd_time().getTime() < System.currentTimeMillis()) {
		...
		<button class="btn con_btn" onclick="send('mylist_sell.jsp');">목록 보기</button>
		<%
		if(id != null && id.equals(dto.getId()) && dto.getStatus() == 0) {
			%>
