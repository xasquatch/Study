...
<%
	...
	FileBoardDTO fdto = dao.getBoard(num);

	int DBnum = fdto.getNum();
	String DBName = fdto.getName();
	String DBSubject = fdto.getSubject();
	String DBContent = ""; // 글 내용

	// 글 내용이 존재한다면 내용 엔터 처리
	if(fdto.getContent() != null)
		DBContent = fdto.getContent().replace("\r\n", "<br>");
%>
<body>
	...
	<div class="container" style="text-align: center;">
		<article> File Notice Update
			<form action="fupdate_pro.jsp?pageNum=<%=pageNum%>" method="post" name="fr" enctype="multipart/form-data">
