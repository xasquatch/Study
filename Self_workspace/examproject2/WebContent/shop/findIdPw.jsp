...
<link type="text/css" rel="stylesheet" href="../css/findIdPw.css" />
				...
				<table width="420" border="0" align="center" cellpadding="0"
					...
					<tr>
						<td style="padding: 15px; border-top: 2px #cccccc solid; border-right: 2px #cccccc solid; 
							...
							<form name="id_f" id="id_f" method="post" action="findId_pro.jsp">
							...
							<form name="pw_f" id="pw_f" method="post" action="findPw_pro.jsp">
								<table width="380" border="0" cellspacing="0" cellpadding="0">
									<tr>
