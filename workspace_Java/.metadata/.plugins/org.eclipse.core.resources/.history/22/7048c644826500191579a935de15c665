...
class Phone2 {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
			System.out.println("전 number:"+number.hashCode());
		result = prime * result + ((number == null) ? 0 : number.hashCode());
			System.out.println("후 number:"+number.hashCode());
			System.out.println();
			System.out.println("전 price:"+price.hashCode());
		result = prime * result + ((price == null) ? 0 : price.hashCode());
			System.out.println("후 price:"+price.hashCode());
			System.out.println("-----------------");
		return result;
	}
